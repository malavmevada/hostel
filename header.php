...
<head>
        ...
        <link rel="icon" href="fees/img/fav-icon.png" type="image/x-icon" />
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
        <title>Hostel Managemnet</title>

        <!-- Icon css link -->
        <link href="fees/css/font-awesome.min.css" rel="stylesheet">
        <link href="fees/vendors/stroke-icon/style.css" rel="stylesheet">
        <!-- Bootstrap -->
        <link href="fees/css/bootstrap.min.css" rel="stylesheet">
        
        <!-- Rev slider css -->
        <link href="fees/vendors/revolution/css/settings.css" rel="stylesheet">
        <link href="fees/vendors/revolution/css/layers.css" rel="stylesheet">
        <link href="fees/vendors/revolution/css/navigation.css" rel="stylesheet">
        <link href="fees/vendors/animate-css/animate.css" rel="stylesheet">
        
        <!-- Extra plugin css -->
        <link href="fees/vendors/magnify-popup/magnific-popup.css" rel="stylesheet">
        <link href="fees/vendors/owl-carousel/owl.carousel.min.css" rel="stylesheet">
        <link href="fees/vendors/bootstrap-datepicker/bootstrap-datetimepicker.min.css" rel="stylesheet">
        <link href="fees/vendors/bootstrap-selector/bootstrap-select.css" rel="stylesheet">
        <link href="fees/vendors/lightbox/simpleLightbox.css" rel="stylesheet">
        
        <link href="fees/css/style.css" rel="stylesheet">
        <link href="fees/css/responsive.css" rel="stylesheet">
...
<body>
        ...
        <script src="fees/js/jquery-2.2.4.js"></script>
        <!-- Include all compiled plugins (below), or include individual files as needed -->
        <script src="fees/js/bootstrap.min.js"></script>
        <!-- Rev slider js -->
        <script src="fees/vendors/revolution/js/jquery.themepunch.tools.min.js"></script>
        <script src="fees/vendors/revolution/js/jquery.themepunch.revolution.min.js"></script>
        <script src="fees/vendors/revolution/js/extensions/revolution.extension.video.min.js"></script>
        <script src="fees/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
        <script src="fees/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
        <script src="fees/vendors/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
        
        <script src="fees/vendors/magnify-popup/jquery.magnific-popup.min.js"></script>
        <script src="fees/vendors/isotope/imagesloaded.pkgd.min.js"></script>
        <script src="fees/vendors/isotope/isotope.pkgd.min.js"></script>
        <script src="fees/vendors/counterup/waypoints.min.js"></script>
        <script src="fees/vendors/counterup/jquery.counterup.min.js"></script>
        <script src="fees/vendors/owl-carousel/owl.carousel.min.js"></script>
        <script src="fees/vendors/bootstrap-datepicker/bootstrap-datetimepicker.min.js"></script>
        <script src="fees/vendors/bootstrap-selector/bootstrap-select.js"></script>
        <script src="fees/vendors/lightbox/simpleLightbox.min.js"></script>
        
        <!--gmaps Js-->
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
        <script src="fees/js/gmaps.min.js"></script>
        
        <!-- instafeed-->
        <script type="text/javascript" src="fees/vendors/instafeed/instafeed.min.js"></script>
        <script type="text/javascript" src="fees/vendors/instafeed/script.js"></script>
        
        <script src="fees/js/theme.js"></script>
